...
\subtitle{Accountable, deterministic and clustered Gossiping protocol} %optional 
...
\dedication{To Satoshi} %optional
...
Finally, I would like to thank all the people I have in the last 5 years with whom I have .... .
...
\end{itemize}
In addition to their normal use, we will exploit hash function to build cryptographic hash-based proof-of-work, as Hashcash. Hashcash PoW, are resource intensive to compute but easy to verify and provide a valid mechanism to limit spam attacks. \\
...
Moreover, other improvements discussed in subsequent researches of BAR Gossip, such as erasure code as done in Flighpath, could be used to generally improve the system.
